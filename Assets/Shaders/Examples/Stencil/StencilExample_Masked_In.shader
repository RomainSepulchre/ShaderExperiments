// Shader for the object that is masked, mask the object when it is inside the mask
// See https://docs.unity3d.com/6000.3/Documentation/Manual/SL-Stencil.html

Shader "LearnShader/Examples/Stencil/StencilExample_Masked_In"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // Multiply texure with a blue color to identify object with shader
                col *= fixed4(0,0,1,1);
