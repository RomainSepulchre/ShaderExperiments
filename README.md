...
- **Intrisic functions**
    ...
    - [Sin and Cos](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/SinCos.shader)
    - [Tan](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/Tan.shader)
    - [Exp, Exp2 and Pow](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/ExpExp2Pow.shader)
    - [Floor](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/Floor.shader)
    - [Step and SmoothStep](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/StepSmoothstep.shader)
    - [Length](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/Length.shader)
    - [Frac](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/Frac.shader)
    - [Lerp](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/Lerp.shader)
    - [Min and Max](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/MinMax.shader)
    - [_Time, _SinTime, _CosTime](Assets/Shaders/Base/CG_HLSL/Intrinsic%20functions/TimeSinTimeCosTime.shader)